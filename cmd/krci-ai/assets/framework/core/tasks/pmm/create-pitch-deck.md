...
Structure content by applying chosen framework to organize pitch deck slides and integrate persuasion elements. Use presentation frameworks from [business-frameworks.md](./.krci-ai/data/shared/business-frameworks.md) as mandatory requirement. Generate final pitch deck using [pitch-deck-template.md](./.krci-ai/templates/pmm/pitch-deck-template.md) structure with visual design guidance and populate all template variables precisely.
</instructions>
